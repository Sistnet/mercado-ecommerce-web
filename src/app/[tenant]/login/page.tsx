...
/**
 * Tenant Login Page - Página de login com tenant dinâmico
 */
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex items-center space-x-2">
                ...
                <Label className="text-sm font-normal cursor-pointer">Lembrar de mim</Label>
              </FormItem>
            )}
          />
          ...
          <p className="text-center text-sm text-muted-foreground">
            Não tem uma conta?{' '}
            <Link href={`/${tenant}/register`} className="text-primary hover:underline font-medium">
              Cadastre-se
            </Link>
          </p>
        </form>
